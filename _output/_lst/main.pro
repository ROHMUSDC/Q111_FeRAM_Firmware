...
extern	int feram_read(unsigned int address,unsigned char *data,unsigned int size);
extern	int feram_continue(void);
extern	void feram_stop(void);
extern	int feram_getStatus(void);
