...
;; File Name       : main.c
	...
	STACKSEG 0100h
CVERSION 3.41.8
CSGLOBAL 03H 0000H "ExtInt_ISR" 08H 02H 0EEH 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "TBC_ISR" 08H 02H 0EAH 00H 80H 00H 00H 00H 07H
CGLOBAL 01H 03H 0000H "main_clrWDT" 08H 02H 0D4H 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "_funcUartFin" 08H 02H 0E4H 00H 81H 02H 00H 00H 07H
CGLOBAL 01H 03H 0000H "main_reqNotHalt" 08H 02H 0E0H 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "TMRAB_ISR" 08H 02H 0ECH 00H 81H 02H 00H 00H 07H
CGLOBAL 01H 03H 0000H "NOPx" 08H 02H 0D8H 00H 82H 08H 00H 00H 07H
CGLOBAL 01H 03H 0000H "UART_RX_TEST" 08H 02H 0F1H 00H 83H 08H 00H 00H 07H
CGLOBAL 01H 03H 0000H "UART_TX_TEST" 08H 02H 0F0H 00H 83H 20H 00H 00H 07H
CGLOBAL 01H 03H 0000H "PWM_B0_ON" 08H 02H 0D9H 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "Initialization" 08H 02H 0D5H 00H 81H 04H 00H 00H 07H
CGLOBAL 01H 03H 0000H "PortA_Digital_Inputs" 08H 02H 0DEH 00H 80H 00H 00H 00H 07H
CGLOBAL 01H 03H 0000H "main" 08H 02H 0F3H 00H 80H 00H 00H 00H 01H
CSGLOBAL 03H 0000H "_intUart" 08H 02H 0E5H 00H 80H 00H 00H 00H 07H
CGLOBAL 01H 03H 0000H "Jerrys_Function" 08H 02H 0F2H 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "_intI2c" 08H 02H 0E8H 00H 81H 02H 00H 00H 07H
CSGLOBAL 03H 0000H "SetOSC" 08H 02H 0D6H 00H 80H 00H 00H 00H 07H
CGLOBAL 01H 03H 0000H "PortC_Low" 08H 02H 0DDH 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "_intADC" 08H 02H 0E9H 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "TMR89_ISR" 08H 02H 0EBH 00H 81H 02H 00H 00H 07H
CGLOBAL 01H 03H 0000H "PortB_Low" 08H 02H 0DCH 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "TMREF_ISR" 08H 02H 0EDH 00H 81H 02H 00H 00H 07H
CGLOBAL 01H 03H 0000H "PortA_Low" 08H 02H 0DBH 00H 80H 00H 00H 00H 07H
CGLOBAL 01H 03H 0000H "analog_comparator" 08H 02H 0DAH 00H 80H 00H 00H 00H 07H
CSGLOBAL 03H 0000H "_funcI2CFin" 08H 02H 0E6H 00H 81H 02H 00H 00H 07H
CGLOBAL 01H 03H 0000H "PinB0_PWM" 08H 02H 0DFH 00H 80H 00H 00H 00H 07H
...
CFILE 000DH 0000002BH "main\\feram.h"
CFILE 0000H 0000051AH "main\\main.c"
...
;;		GPIO_17 ^=1; 
CLINEA 0000H 0001H 012DH 0003H 000FH
	tb	0f250h.0
	beq	_$M1
	rb	0f250h.0
	bal	_$M2
...
;;		feram_init();
CLINEA 0000H 0001H 012EH 0003H 000FH
	bl	_feram_init

;;		main_clrWDT();
CLINEA 0000H 0001H 012FH 0003H 0010H
	bl	_main_clrWDT

;;		NOPx(65000);
CLINEA 0000H 0001H 0130H 0003H 000EH
	mov	r0,	#0e8h
	mov	r1,	#0fdh
	bl	_NOPx
...
;;	goto Primary_Loop;
CLINEA 0000H 0001H 0133H 0002H 0013H
	bal	_$L31
CBLOCKEND 243 2 310

;;}//end main
CLINEA 0000H 0001H 0136H 0001H 000BH
CBLOCKEND 243 1 310
CFUNCTIONEND 243
...
;;		do {
CLINEA 0000H 0001H 0152H 0003H 0006H
_$L35 :
CBLOCK 212 3 338

;;			WDTCON = 0x5Au;
CLINEA 0000H 0001H 0153H 0004H 0012H
	mov	r0,	#05ah
	st	r0,	0f00eh
CBLOCKEND 212 3 340

;;		} while (WDP != 1);
CLINEA 0000H 0000H 0154H 0003H 0015H
	tb	0f00eh.0
	beq	_$L35

;;		WDTCON = 0xA5u;
CLINEA 0000H 0001H 0155H 0003H 0011H
	mov	r0,	#0a5h
	st	r0,	0f00eh
CBLOCKEND 212 2 344
...
CLINEA 0000H 0001H 0162H 0004H 0034H
	rb	0f02ah.2

;;			DUA1  = 1; // 0=> Enables Uart1 
CLINEA 0000H 0001H 0163H 0004H 0023H
	sb	0f02ah.3
...
;;     	SetOSC(); 	//8MHz
CLINEA 0000H 0001H 0175H 0007H 0017H
	bl	_SetOSC

;;		irq_di();	// Disable Interrupts
CLINEA 0000H 0001H 01D9H 0003H 0021H
	bl	_irq_di

;;				IE0 = IE1 = IE2 = IE3 = IE4 = IE5 = IE6 = IE7 = 0;
CLINEA 0000H 0001H 01F5H 0005H 0036H
	mov	r0,	#00h
	st	r0,	0f017h
	st	r0,	0f016h
	st	r0,	0f015h
...
CLINEA 0000H 0001H 01F9H 0005H 003EH
	st	r0,	0f01fh
	st	r0,	0f01eh
	st	r0,	0f01dh
	st	r0,	0f01ch
...
CLINEA 0000H 0001H 01FCH 0005H 003FH
...
CLINEA 0000H 0001H 0203H 0006H 0054H
	sb	0f012h.7

;;					QI2CM = 0;
CLINEA 0000H 0001H 0204H 0006H 000FH
	rb	0f01ah.7

;;				(void)irq_setHdr( (unsigned char)IRQ_NO_SADINT, _intADC );
CLINEA 0000H 0001H 0208H 0005H 003EH
...
CLINEA 0000H 0001H 020FH 0006H 0038H
	sb	0f017h.3

;;					Q2H = 0;	  // Request flag for the TIME BASE COUNTER 2Hz Interrupt
CLINEA 0000H 0001H 0210H 0006H 0047H
	rb	0f01fh.3
...
CLINEA 0000H 0001H 0217H 0005H 0060H
...
CLINEA 0000H 0001H 0218H 0006H 0038H
	sb	0f013h.2

;;					ETM9 = 1;	  	// Enable timer 9 Interrupt (1=ENABLED)
CLINEA 0000H 0001H 0219H 0006H 0039H
	sb	0f013h.3

;;					QTM8 = 0;		// Timer 8 IRQ request flag; 1=REQUEST
CLINEA 0000H 0001H 021AH 0006H 0036H
	rb	0f01bh.2
...
;;					T9CS2 = 1; 
CLINEA 0000H 0001H 0221H 0006H 0010H
	sb	0f8e6h.2
...
CLINEA 0000H 0001H 0226H 0006H 002FH
	sb	0f8e2h.5

;;					HTD3 = 1;	//High-Speed Time Base Counter Divide Register: 1111 = 9182kHz
CLINEA 0000H 0001H 0228H 0006H 004DH
	sb	0f00bh.3

;;					HTD2 = 1;
CLINEA 0000H 0001H 0229H 0006H 000EH
	sb	0f00bh.2
...
CLINEA 0000H 0001H 0231H 0006H 0038H
	sb	0f015h.6

;;					ETMB = 1;	  	// Enable timer 9 Interrupt (1=ENABLED)
CLINEA 0000H 0001H 0232H 0006H 0039H
	sb	0f015h.7

;;					QTMA = 0;		// timer 8 IRQ request flag; 1=REQUEST
CLINEA 0000H 0001H 0233H 0006H 0036H
	rb	0f01dh.6
...
;;					TBCS2 = 1; 
CLINEA 0000H 0001H 023AH 0006H 0010H
	sb	0f8eeh.2

;;					tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 023BH 0006H 001AH
	mov	r0,	#01h
	bl	_tm_init
...
CLINEA 0000H 0001H 023FH 0006H 002FH
	sb	0f8eah.5

;;					HTD3 = 1;	//High-Speed Time Base Counter Divide Register: 1111 = 9182kHz
CLINEA 0000H 0001H 0241H 0006H 004DH
	sb	0f00bh.3

;;					HTD2 = 1;
CLINEA 0000H 0001H 0242H 0006H 000EH
	sb	0f00bh.2
...
CLINEA 0000H 0001H 024AH 0006H 0038H
	sb	0f015h.4

;;					ETMF = 1;	  	// Enable timer F Interrupt (1=ENABLED)
CLINEA 0000H 0001H 024BH 0006H 0039H
	sb	0f015h.5

;;					QTME = 0;		// Timer E IRQ request flag; 1=REQUEST
CLINEA 0000H 0001H 024CH 0006H 0036H
	rb	0f01dh.4
...
;;					tm_init(TM_CH_NO_EF);
CLINEA 0000H 0001H 0254H 0006H 001AH
	mov	r0,	#02h
	bl	_tm_init
...
CLINEA 0000H 0001H 0258H 0006H 002FH
	sb	0f362h.2

;;					HTD3 = 1;	//High-Speed Time Base Counter Divide Register: 1111 = 9182kHz
CLINEA 0000H 0001H 025AH 0006H 004DH
	sb	0f00bh.3

;;					HTD2 = 1;
CLINEA 0000H 0001H 025BH 0006H 000EH
	sb	0f00bh.2
...
;;					PB3C1 = 0;
CLINEA 0000H 0001H 0262H 0006H 000FH
	rb	0f25bh.3
...
CLINEA 0000H 0001H 0267H 0006H 0055H
	rb	0f024h.7

;;					PB3SM = 0;
CLINEA 0000H 0001H 0268H 0006H 000FH
	rb	0f026h.7

;;			(void)irq_setHdr( (unsigned char)IRQ_NO_PB3INT, ExtInt_ISR );  //Clear interrupt request flag
CLINEA 0000H 0001H 026CH 0004H 0060H
...
CLINEA 0000H 0001H 026DH 0006H 0027H
	rb	0f011h.7

;;					QPB3 = 0;	// EXT IRQ request flag; 1=REQUEST	
CLINEA 0000H 0001H 026EH 0006H 0032H
	rb	0f019h.7
...
CLINEA 0000H 0001H 0276H 0003H 002AH
	mov	r0,	#03h
	st	r0,	0f00fh

;;		main_clrWDT(); 	// Clear WDT   
CLINEA 0000H 0001H 0277H 0003H 0021H
	bl	_main_clrWDT

;;				 &_uartSetParam );						// Parameters from Structure    
CLINEA 0000H 0001H 0282H 0006H 003CH
...
CLINEA 0000H 0001H 0283H 0003H 002FH
	bl	_uart_PortSet
...
CLINEA 0000H 0001H 029AH 0001H 0019H
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
CLINEA 0000H 0001H 029EH 0003H 004CH
	rb	0f002h.0

;;		SYSC1  = 0;			//...
CLINEA 0000H 0001H 029FH 0003H 0015H
	rb	0f002h.1

;;		OSCM1  = 1;			// 10 => Built-in PLL oscillation mode
CLINEA 0000H 0001H 02A0H 0003H 0036H
	sb	0f002h.3

;;		OSCM0  = 0;			//...
CLINEA 0000H 0001H 02A1H 0003H 0015H
	rb	0f002h.2

;;		ENOSC  = 1;			// 1=Enable High Speed Oscillator...
CLINEA 0000H 0001H 02A4H 0003H 0034H
	sb	0f003h.1

;;		SYSCLK = 1;			// Select System Clock: 1=HSCLK; 0=LSCLK 
CLINEA 0000H 0001H 02A5H 0003H 0039H
	sb	0f003h.0

;;		LPLL   = 1;			// 1=Enables the use of PLL oscillation - ADDED 4/30/2013
CLINEA 0000H 0001H 02A6H 0003H 0049H
	sb	0f003h.7

;;	__EI();					//INT enable
CLINEA 0000H 0001H 02A8H 0002H 0019H
	ei
CBLOCKEND 214 2 681
...
CLINEA 0000H 0001H 02B0H 0001H 001DH
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
CLINEA 0000H 0001H 02C6H 0002H 0025H
	sb	0f950h.0

;;	CMP0E1  = 0x00; 	// No Interupt...
CLINEA 0000H 0001H 02C7H 0002H 0023H
	rb	0f951h.1
...
CLINEA 0000H 0001H 02C9H 0002H 0030H
	rb	0f951h.3

;;	CMP0RFS = 0x01; 	// Differential Input on B5
CLINEA 0000H 0001H 02CAH 0002H 002DH
	sb	0f951h.4

;;	CMP0EN  = 0x00;
CLINEA 0000H 0001H 02CDH 0002H 0010H
	rb	0f950h.0
CBLOCKEND 218 2 720

;;}
CLINEA 0000H 0001H 02D0H 0001H 0001H
	rt
CBLOCKEND 218 1 720
CFUNCTIONEND 218
...
;;void PortA_Low(void){
CLINEA 0000H 0001H 02D8H 0001H 0015H
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
CLINEA 0000H 0001H 02E9H 0002H 0031H
	sb	0f253h.1
...
CLINEA 0000H 0001H 02EBH 0002H 0031H
	sb	0f253h.2

;;	PA2C0  = 1;	
CLINEA 0000H 0001H 02ECH 0002H 000DH
	sb	0f252h.2
...
;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 02F4H 0002H 000EH
	rb	0f254h.2
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 02FBH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 219 2 765
...
;;void PortB_Low(void){
CLINEA 0000H 0001H 0303H 0001H 0015H
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
CLINEA 0000H 0001H 031FH 0002H 0031H
	sb	0f25bh.4
...
CLINEA 0000H 0001H 0329H 0002H 003CH
	rb	0f25dh.0

;;	PB0MD0  = 0;	
CLINEA 0000H 0001H 032AH 0002H 000EH
	rb	0f25ch.0
...
;;void PortC_Low(void){
CLINEA 0000H 0001H 034CH 0001H 0015H
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
;;	PC2C0  = 1;	
CLINEA 0000H 0001H 0362H 0002H 000DH
	sb	0f262h.2
...
;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 0376H 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 221 2 888
...
CLINEA 0000H 0001H 037EH 0001H 0020H
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
CLINEA 0000H 0001H 0388H 0002H 0030H
	sb	0f251h.0
...
CLINEA 0000H 0001H 038EH 0002H 0041H
	sb	0f253h.0

;;	PA0C0  = 0;		
CLINEA 0000H 0001H 038FH 0002H 000EH
	rb	0f252h.0

;;	PA1C1  = 1;		// PortA Bit1 set to Input with Pull-Up Resistor...
CLINEA 0000H 0001H 0390H 0002H 0041H
	sb	0f253h.1
...
CLINEA 0000H 0001H 0392H 0002H 0041H
	sb	0f253h.2

;;	PA2C0  = 0;	
CLINEA 0000H 0001H 0393H 0002H 000DH
	rb	0f252h.2

;;	PA0MD1  = 0;	// PortA Bit0 set to General Purpose I/O...
CLINEA 0000H 0001H 0396H 0002H 0039H
	rb	0f255h.0

;;	PA0MD0  = 0;	
CLINEA 0000H 0001H 0397H 0002H 000EH
	rb	0f254h.0

;;	PA1MD1  = 0;	// PortA Bit1 set to General Purpose I/O...
CLINEA 0000H 0001H 0398H 0002H 0039H
	rb	0f255h.1
...
CLINEA 0000H 0001H 039AH 0002H 0039H
	rb	0f255h.2

;;	PA2MD0  = 0;	
CLINEA 0000H 0001H 039BH 0002H 000EH
	rb	0f254h.2

;;	main_clrWDT(); 	// Clear WDT
CLINEA 0000H 0001H 039DH 0002H 001DH
	b	_main_clrWDT
CBLOCKEND 222 2 927
CLINEA 0000H 0001H 039FH 0001H 0001H
CBLOCKEND 222 1 927
CFUNCTIONEND 222
...
CLINEA 0000H 0001H 03A5H 0001H 002EH
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
CLINEA 0000H 0001H 03A9H 0004H 0084H
	st	er0,	0f910h

;;			PWCD =    myDutyCycle;		//12    ~  0.25% duty cycle @ 160Hz
CLINEA 0000H 0001H 03B1H 0004H 003EH
	st	er2,	0f912h

;;		PCRUN = 1;		// TURN PWM ON
CLINEA 0000H 0001H 03B3H 0003H 001CH
	sb	0f917h.0
CBLOCKEND 217 2 949

;;}//END PWM_B0_ON Function
CLINEA 0000H 0001H 03B5H 0001H 0019H
	rt
CBLOCKEND 217 1 949
CFUNCTIONEND 217
...
;;void PinB0_PWM(void){
CLINEA 0000H 0001H 03BDH 0001H 0015H
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
;;	PB0C0  = 1;		
CLINEA 0000H 0001H 03CDH 0002H 000EH
	sb	0f25ah.0

;;	PB0MD1  = 0;	// PortB Bit0 set to PWM Output (0,1)...
CLINEA 0000H 0001H 03D0H 0002H 0036H
	rb	0f25dh.0

;;	PB0MD0  = 1;	
CLINEA 0000H 0001H 03D1H 0002H 000EH
	sb	0f25ch.0

;;	PCCS1 = 0;	//00= LS; 01=HS; 10=PLL
CLINEA 0000H 0001H 03D5H 0002H 0023H
	rb	0f916h.1

;;	PCCS0 = 1;
CLINEA 0000H 0001H 03D6H 0002H 000BH
	sb	0f916h.0

;;	PWCP = 4250;		// Init Period to (1=255kHz; 10=46kHz; 50=10kHz; 200=2.5kH; ; 3185 = 160Hz; 3400=150Hz; 4250=120Hz; 5000=102Hz)
CLINEA 0000H 0001H 03D9H 0002H 007EH
	mov	r0,	#09ah
	mov	r1,	#010h
	st	er0,	0f910h

;;	PWCD =    12;		//12    ~  0.25% duty cycle @ 160Hz
CLINEA 0000H 0001H 03E3H 0002H 0033H
	mov	er0,	#12
	st	er0,	0f912h

;;	PCRUN = 0;		// OFF to start
CLINEA 0000H 0001H 03E5H 0002H 001CH
	rb	0f917h.0
CBLOCKEND 223 2 999
...
;;{
CLINEA 0000H 0001H 043FH 0001H 0001H
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
CLINEA 0000H 0001H 0440H 0002H 0053H
	bl	_uart_continue

;;	_flgUartFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0441H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __flgUartFin

;;	main_reqNotHalt();						// uncommented 5/2/2013
CLINEA 0000H 0001H 0442H 0002H 0030H
	bl	_main_reqNotHalt
CBLOCKEND 228 2 1091

;;}
CLINEA 0000H 0001H 0443H 0001H 0001H
	pop	pc
CBLOCKEND 228 1 1091
CFUNCTIONEND 228
...
CLINEA 0000H 0001H 044FH 0002H 0053H
	bl	_i2c_continue

;;	_flgI2CFin = (unsigned char)FLG_SET;
CLINEA 0000H 0001H 0450H 0002H 0025H
	mov	r0,	#01h
	st	r0,	NEAR __flgI2CFin

;;	main_reqNotHalt();						// uncommented 5/2/2013
CLINEA 0000H 0001H 0451H 0002H 0030H
	bl	_main_reqNotHalt
CBLOCKEND 230 2 1106

;;}
CLINEA 0000H 0001H 0452H 0001H 0001H
	pop	pc
CBLOCKEND 230 1 1106
CFUNCTIONEND 230
...
;;	(void)i2c_continue();
CLINEA 0000H 0001H 045DH 0002H 0016H
	bl	_i2c_continue

;;	main_reqNotHalt();
CLINEA 0000H 0001H 045EH 0002H 0013H
	bl	_main_reqNotHalt
CBLOCKEND 232 2 1119

;;}
CLINEA 0000H 0001H 045FH 0001H 0001H
	pop	pc
CBLOCKEND 232 1 1119
CFUNCTIONEND 232
...
;;	_flgADCFin = 1;
CLINEA 0000H 0001H 046AH 0002H 0010H
	mov	r0,	#01h
	st	r0,	NEAR __flgADCFin
CBLOCKEND 233 2 1131

;;}
CLINEA 0000H 0001H 046BH 0001H 0001H
	rt
CBLOCKEND 233 1 1131
CFUNCTIONEND 233
...
CLINEA 0000H 0001H 0476H 0002H 0026H
	mov	r0,	#01h
	st	r0,	NEAR __reqNotHalt
CBLOCKEND 224 2 1143

;;}
CLINEA 0000H 0001H 0477H 0001H 0001H
	rt
CBLOCKEND 224 1 1143
CFUNCTIONEND 224
...
CLINEA 0000H 0001H 0482H 0002H 0047H
	b	_uart_continue
CBLOCKEND 229 2 1155
CLINEA 0000H 0001H 0483H 0001H 0001H
CBLOCKEND 229 1 1155
CFUNCTIONEND 229
...
CLINEA 0000H 0000H 0041H 0002H 000DH
	mov	r0,	#0fh
	st	r0,	0f00bh
CBLOCKEND 234 2 1167

;;}
CLINEA 0000H 0001H 048FH 0001H 0001H
	rt
CBLOCKEND 234 1 1167
CFUNCTIONEND 234
...
;;	tm_init(TM_CH_NO_89);
CLINEA 0000H 0001H 0498H 0002H 0016H
	mov	r0,	#00h
	bl	_tm_init
...
CLINEA 0000H 0000H 00CBH 0002H 000BH
	sb	0f8e3h.0
CBLOCKEND 235 2 1178

;;}
CLINEA 0000H 0001H 049AH 0001H 0001H
	pop	pc
CBLOCKEND 235 1 1178
CFUNCTIONEND 235
...
;;	tm_init(TM_CH_NO_AB);
CLINEA 0000H 0001H 04A3H 0002H 0016H
	mov	r0,	#01h
	bl	_tm_init
...
CLINEA 0000H 0000H 00D2H 0002H 000BH
	sb	0f8ebh.0
CBLOCKEND 236 2 1189

;;}
CLINEA 0000H 0001H 04A5H 0001H 0001H
	pop	pc
CBLOCKEND 236 1 1189
CFUNCTIONEND 236
...
CLINEA 0000H 0000H 00D9H 0002H 000BH
	sb	0f363h.0
CBLOCKEND 237 2 1200

;;}
CLINEA 0000H 0001H 04B0H 0001H 0001H
	pop	pc
CBLOCKEND 237 1 1200
CFUNCTIONEND 237
...
CBLOCK 238 2 1207
CBLOCKEND 238 2 1211

;;}
CLINEA 0000H 0001H 04BBH 0001H 0001H
	rt
CBLOCKEND 238 1 1211
CFUNCTIONEND 238
...
CLINEA 0000H 0001H 04C1H 0001H 0017H
	mov	er0,	#0 
	st	er0,	_ONCNT$0[fp]

;;xxx = MyCount;
CLINEA 0000H 0001H 04C4H 0001H 000EH
	st	er8,	_xxx$2[fp]
...
;;		ONCNT++;
CLINEA 0000H 0000H 04C7H 0003H 000AH
	add	er0,	#1 
	st	er0,	_ONCNT$0[fp]
CBLOCKEND 216 3 1224
...
;;	while(ONCNT < xxx) {	// NOP for "xxx" Cycles
CLINEA 0000H 0000H 04C6H 0000H 0000H
	l	er2,	_xxx$2[fp]
	cmp	er0,	er2
	blt	_$L60
CBLOCKEND 216 2 1226
...
CLINEA 0000H 0001H 04DDH 0003H 0048H
	mov	r0,	#04dh
...
;;		_flgUartFin = 0;
CLINEA 0000H 0001H 04E0H 0003H 0012H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;		uart_stop();
CLINEA 0000H 0001H 04E1H 0003H 000EH
	bl	_uart_stop

;;		uart_startSend(UARTStartupMessage, 26, _funcUartFin);
CLINEA 0000H 0001H 04E2H 0003H 0037H
...
;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 04E3H 0001H 0001H
	bal	_$L68

;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 04E3H 0003H 001AH
_$L66 :
CBLOCK 240 3 1251
...
CLINEA 0000H 0001H 04EEH 0001H 0018H
;;*****************************************
;;	register/stack information
;;*****************************************
	_MyRx$0	set	-1
...
;;		_flgUartFin = 0;
CLINEA 0000H 0001H 04FBH 0003H 0012H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;		uart_stop();
CLINEA 0000H 0001H 04FCH 0003H 000EH
	bl	_uart_stop

;;		uart_startReceive(MyRx, 1, _funcUartFin);	// RX!
CLINEA 0000H 0001H 04FDH 0003H 0032H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	er2,	#1 
...
;;		while(_flgUartFin != 1){
CLINEA 0000H 0000H 04FEH 0003H 001AH
_$L78 :
CBLOCK 241 4 1278

;;			main_clrWDT();	
CLINEA 0000H 0001H 04FFH 0004H 0012H
	bl	_main_clrWDT
CBLOCKEND 241 4 1281
...
;;		if(MyRx[0] != 0x20){			
CLINEA 0000H 0001H 0504H 0003H 0019H
	l	r0,	_MyRx$0[fp]
	cmp	r0,	#020h
	beq	_$L83
CBLOCK 241 5 1284
...
;;			_flgUartFin = 0;
CLINEA 0000H 0001H 0506H 0004H 0013H
	mov	r0,	#00h
	st	r0,	NEAR __flgUartFin

;;			uart_stop();
CLINEA 0000H 0001H 0507H 0004H 000FH
	bl	_uart_stop

;;			uart_startSend(MyRx, 1, _funcUartFin);	// TX!
CLINEA 0000H 0001H 0508H 0004H 0030H
	mov	r0,	#BYTE1 OFFSET __funcUartFin
	mov	r1,	#BYTE2 OFFSET __funcUartFin
	push	er0
	mov	er2,	#1 
...
;;			while(_flgUartFin != 1){
CLINEA 0000H 0000H 0509H 0004H 001BH
_$L84 :
CBLOCK 241 6 1289

;;				main_clrWDT(); 
CLINEA 0000H 0001H 050AH 0005H 0013H
	bl	_main_clrWDT
CBLOCKEND 241 6 1291
...
;;			}
CLINEA 0000H 0000H 050BH 0004H 0004H
_$L83 :
CBLOCKEND 241 5 1292
CBLOCKEND 241 2 1295
...
CLINEA 0000H 0001H 0513H 0001H 001BH
;;*****************************************
;;	register/stack information
;;*****************************************
;;*****************************************
...
CBLOCK 242 2 1299
CLOCAL 4BH 0002H 0000H 0002H "i" 02H 00H 01H
CBLOCKEND 242 2 1303

;;}
CLINEA 0000H 0001H 0517H 0001H 0001H
	rt
CBLOCKEND 242 1 1303
CFUNCTIONEND 242
